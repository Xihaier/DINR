...
with plt.style.context('science'):
    ...
    plt.plot(effective_rank_ocffnet_withoutOT, label="OCFFNet without OT")
    plt.legend()
    ...
    plt.plot(condition_number_ocffnet_withoutOT, label="OCFFNet without OT")
    plt.legend()
    ...
    plt.plot(spectrum_decay_ocffnet_withoutOT, label="OCFFNet without OT")
    plt.legend()
    ...
    plt.plot(trace_ocffnet_withoutOT, label="OCFFNet without OT")
    plt.legend()
    plt.title("trace")
